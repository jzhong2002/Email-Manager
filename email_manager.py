...
class EmailManager():
    ...
    def read_message(self):
        try:
            ...
            messagebox.showinfo("WARNING", "You must put in an integer!")
    ...
    def new_message(self):
        NewMessage(tk.Toplevel(window), EmailManager)
        self.status_lbl.configure(text="You have just clicked on the new message button!")

    def label_messages(self):
        LabelMessages(tk.Toplevel(window))
        self.status_lbl.configure(text="Label Message button was clicked! Label was added")
